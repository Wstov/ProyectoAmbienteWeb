      ...
      <!-- Contenedor para alinear los botones -->
        ...
        <!-- Botón Agregar al Carrito -->
                            ...
                            <!-- Botón Alquilar Libro -->
                              <a style="--clr: #1c1c1c" class="button" href="./alquilarLibro.php?LibroID=<?= htmlspecialchars($showBook->LibroID) ?>">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="p-2">
                                              <h5 class="mb-1 text-secondary"><?= strlen($book->Titulo) > 20 ? htmlspecialchars(substr($book->Titulo, 0, 20)) . '...' : htmlspecialchars($book->Titulo) ?></h5>
                                                <p class="mb-1 text-secondary"><?= strlen($book->Autor) > 20 ? htmlspecialchars(substr($book->Autor, 0, 20)) . '...' : htmlspecialchars($book->Autor) ?></p>
