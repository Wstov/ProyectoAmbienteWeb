            ...
            <table class="table table-hover ">
                ...
                <tbody>
                    <?php while ($row = $sql->fetch_object()) { ?>
                        <tr>
                            <td class="text-center"><?= htmlspecialchars($row->Nombre) ?></td>
                            <td class="text-center"><?= htmlspecialchars($row->Apellido) ?></td>
                            <td class="text-center"><?= htmlspecialchars($row->Email) ?></td>
                            <td class="text-center"><?= htmlspecialchars($row->RolID == 2 ? 'Administrador' : ($row->RolID == 1 ? 'Cliente' : '')) ?></td>
                            
                            
                              <td class=" text-center-custom d-flex align-items-center justify-content-center ">
                                  <a href="./editarUsuario.php?UsuarioID=<?= htmlspecialchars($row->UsuarioID) ?>" class="edit-button" title="Editar">
                                  ...
                                  <a href="#" class="delete-button" title="Eliminar" data-bs-toggle="modal" data-bs-target="#deleteModal" data-bs-id="<?= htmlspecialchars($row->UsuarioID) ?>">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form id="deleteForm" action="../../php/usuario/eliminarUsuario.php" method="POST">
          <input type="hidden" name="UsuarioID" id="deleteUsuarioID">
