                    ...
                    <?php while ($row = $sql->fetch_object()) { ?>
                        <tr>
                            <!-- <td class="text-center">
                                <img src="../../booksImages/<?= htmlspecialchars($row->ImagenURL) ?>" alt="Imagen de <?= htmlspecialchars($row->Titulo) ?>" class="img-fluid" style="max-width: 100px; height: auto;">
                            </td>                             -->
                            ...
                            <td class="text-center"><?= number_format($row->Precio, 2, ',', '.') ?></td>
                              ...
                              <td class=" text-center-custom d-flex align-items-center justify-content-center ">
                                  ...
                                  <a href="../../php/eliminarLibro.php?LibroID=<?= htmlspecialchars($row->LibroID) ?>" class="delete-button" title="Eliminar">
